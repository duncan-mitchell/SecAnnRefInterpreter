...
and pretty_expr = function
  ...
  | As (_, e1, e2) -> squish [pretty_expr e1; text " as "; pretty_expr e2]
  | Drop (_, e1, e2) -> squish [pretty_expr e1; text " drop "; pretty_expr e2]
  | CpAnn (_, e1, e2) -> squish [text "cpAnn"; 
      parens (horz [pretty_expr e1; text ", "; pretty_expr e2])]
  | Assert (_, e1, e2) -> squish [text "Assert"; 
      parens (horz [pretty_expr e1; text " : "; pretty_expr e2])]
  | SecAnn (_, e1) -> squish [text "SecAnn "; pretty_expr e1]
  | Extends (_, e1, e2) -> 
      squish [text "SecAnn "; pretty_expr e1; text " Extends "; pretty_expr e2]
